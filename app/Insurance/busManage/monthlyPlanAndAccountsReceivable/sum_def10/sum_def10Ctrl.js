app.controller('sum_def10Ctrl', function ($rootScope, $scope, $http, $stateParams, uiGridConstants, ngDialog, ngVerify, $location, activitiModal) {
    ...
    $scope.initData = function (data) {
        ...
        var columnDefsDtata = [
            ...
            {name: 'verf38', displayName: '环境污染责任险项目', type: 'number', enableCellEdit: true},
            {name: 'verf39', displayName: '安全生产责任险项目', type: 'number', enableCellEdit: true},
            {name: 'verf40', displayName: '食品安全责任险项目', type: 'number', enableCellEdit: true},
            {name: 'verf41', displayName: '其他政府保险项目', type: 'number', enableCellEdit: true},
            {name: 'verf42', displayName: '鲁能集团及下属单位', type: 'number', enableCellEdit: true},
            {name: 'verf43', displayName: '中核建集团及下属单位', type: 'number', enableCellEdit: true},
            {name: 'verf44', displayName: '保险同业咨询', type: 'number', enableCellEdit: true},
            {name: 'verf45', displayName: '其他社会市场', type: 'number', enableCellEdit: true},
            {name: 'verf46', displayName: '个人保险业务', type: 'number', enableCellEdit: true}
        ];
        //险种
        var insuranceType = [
            {
        ...
        $scope.childgridOptions = {
            ...
            onRegisterApi: function (gridApi) {
                ...
                $scope.childgridOptions.gridApi.edit.on.afterCellEdit($scope, function (rowEntity, colDef, newValue, oldValue) {
                    ...
                    //修改行总计
                    var rowNum = $scope.childgridOptions.data[rowEntity.id].verf38 + $scope.childgridOptions.data[rowEntity.id].verf39 + $scope.childgridOptions.data[rowEntity.id].verf40 +
                        $scope.childgridOptions.data[rowEntity.id].verf41 + $scope.childgridOptions.data[rowEntity.id].verf42 + $scope.childgridOptions.data[rowEntity.id].verf43 +
                        $scope.childgridOptions.data[rowEntity.id].verf44 + $scope.childgridOptions.data[rowEntity.id].verf45 + $scope.childgridOptions.data[rowEntity.id].verf46;
                    $scope.childgridOptions.data[rowEntity.id].sumDef1 = rowNum.toFixed(2);

                    //修改列总计
                    var colNum = 0;
                    for (var i = 0; i <= 12; i++) {
                        if (colDef.name == "verf38") {
                            colNum = $scope.childgridOptions.data[i].verf38 + colNum;
                            $scope.childgridOptions.data[13].verf38 = colNum.toFixed(2);
                        }
                        if (colDef.name == "verf39") {
                            colNum = $scope.childgridOptions.data[i].verf39 + colNum;
                            $scope.childgridOptions.data[13].verf39 = colNum.toFixed(2);
                        }
                        if (colDef.name == "verf40") {
                            colNum = $scope.childgridOptions.data[i].verf40 + colNum;
                            $scope.childgridOptions.data[13].verf40 = colNum.toFixed(2);
                        }
                        if (colDef.name == "verf41") {
                            colNum = $scope.childgridOptions.data[i].verf41 + colNum;
                            $scope.childgridOptions.data[13].verf41 = colNum.toFixed(2);
                        }
                        if (colDef.name == "verf42") {
                            colNum = $scope.childgridOptions.data[i].verf42 + colNum;
                            $scope.childgridOptions.data[13].verf42 = colNum.toFixed(2);
                        }
                        if (colDef.name == "verf43") {
                            colNum = $scope.childgridOptions.data[i].verf43 + colNum;
                            $scope.childgridOptions.data[13].verf43 = colNum.toFixed(2);
                        }
                        if (colDef.name == "verf44") {
                            colNum = $scope.childgridOptions.data[i].verf44 + colNum;
                            $scope.childgridOptions.data[13].verf44 = colNum.toFixed(2);
                        }
                        if (colDef.name == "verf45") {
                            colNum = $scope.childgridOptions.data[i].verf45 + colNum;
                            $scope.childgridOptions.data[13].verf45 = colNum.toFixed(2);
                        }
                        if (colDef.name == "verf46") {
                            colNum = $scope.childgridOptions.data[i].verf46 + colNum;
                            $scope.childgridOptions.data[13].verf46 = colNum.toFixed(2);
                        }
                    }

                    //修改第13行的总计
                    var sumDef1RowNum = eval($scope.childgridOptions.data[13].verf38) + eval($scope.childgridOptions.data[13].verf39) + eval($scope.childgridOptions.data[13].verf40) + eval($scope.childgridOptions.data[13].verf41) +
                        eval($scope.childgridOptions.data[13].verf42) + eval($scope.childgridOptions.data[13].verf43) + eval($scope.childgridOptions.data[13].verf44) + eval($scope.childgridOptions.data[13].verf45) +
                        eval($scope.childgridOptions.data[13].verf46);
                    ...
                    var sum_def1 = 0;
                    $scope.VO.sumDef1 = sum_def1;
                    //修改市场合计   除去股东都是市场合计
                    var sum_def2 = eval($scope.childgridOptions.data[13].verf38) + eval($scope.childgridOptions.data[13].verf39) + eval($scope.childgridOptions.data[13].verf40) + eval($scope.childgridOptions.data[13].verf41) +
                        eval($scope.childgridOptions.data[13].verf42) + eval($scope.childgridOptions.data[13].verf43) + eval($scope.childgridOptions.data[13].verf44) + eval($scope.childgridOptions.data[13].verf45) +
                        eval($scope.childgridOptions.data[13].verf46);
        ...
        $scope.onCard = function (id) {
            ...
            $http.post($scope.basePath + "workFlow/findOneFlowInfo", {
                ...
                if (response && response.code == "200") {
                    ...
                    $scope.childgridOptions.data = $scope.VO.monthRecordB;
                    ;
    ...
    $scope.initPage = function () {
        ...
        $scope.gridOptions = {
            ...
            exporterCsvFilename: '社会市场业务应收账款.csv',
            columnDefs: [
                ...
                {name: 'vapprovenote', displayName: '审核意见', width: 100,},
