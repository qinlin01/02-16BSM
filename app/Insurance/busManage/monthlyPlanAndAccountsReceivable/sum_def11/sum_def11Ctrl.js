app.controller('sum_def11Ctrl', function ($rootScope, $scope, $http, $stateParams, uiGridConstants, ngDialog, ngVerify, $location, activitiModal) {
    ...
    $scope.initData = function (data) {
        ...
        var columnDefsDtata = [
            ...
            {name: 'verf1', displayName: '金融创新中心推广业务', type: 'number', enableCellEdit: true},
            {name: 'verf2', displayName: '业务创新项目一部', type: 'number', enableCellEdit: true},
            {name: 'verf3', displayName: '业务创新项目二部', type: 'number', enableCellEdit: true}
        ];
        //险种
        var insuranceType = [
            {id: 0, insuranceName: "财产险", sumDef1: 0, verf1: 0, verf2: 0, verf3: 0},
            {id: 1, insuranceName: "机器损坏险", sumDef1: 0, verf1: 0, verf2: 0, verf3: 0},
            {id: 2, insuranceName: "供电责任险", sumDef1: 0, verf1: 0, verf2: 0, verf3: 0},
            {id: 3, insuranceName: "公众责任险", sumDef1: 0, verf1: 0, verf2: 0, verf3: 0},
            {id: 4, insuranceName: "雇主责任保险", sumDef1: 0, verf1: 0, verf2: 0, verf3: 0},
            {id: 5, insuranceName: "机动车辆险", sumDef1: 0, verf1: 0, verf2: 0, verf3: 0},
            {id: 6, insuranceName: "在建工程险", sumDef1: 0, verf1: 0, verf2: 0, verf3: 0},
            {id: 7, insuranceName: "其他保险", sumDef1: 0, verf1: 0, verf2: 0, verf3: 0},
            {id: 8, insuranceName: "咨询费", sumDef1: 0, verf1: 0, verf2: 0, verf3: 0},
            {id: 9, insuranceName: "意外伤害保险", sumDef1: 0, verf1: 0, verf2: 0, verf3: 0},
            {id: 10, insuranceName: "健康保险", sumDef1: 0, verf1: 0, verf2: 0, verf3: 0},
            {id: 11, insuranceName: "人寿保险", sumDef1: 0, verf1: 0, verf2: 0, verf3: 0},
            {id: 12, insuranceName: "咨询业务", sumDef1: 0, verf1: 0, verf2: 0, verf3: 0},
            {id: 13, insuranceName: "合计（万元）", sumDef1: 0, verf1: 0, verf2: 0, verf3: 0}];
        $scope.childgridOptions = {
            ...
            onRegisterApi: function (gridApi) {
                ...
                $scope.childgridOptions.gridApi.edit.on.afterCellEdit($scope, function (rowEntity, colDef, newValue, oldValue) {
                    ...
                    //修改行总计
                    var rowNum = $scope.childgridOptions.data[rowEntity.id].verf1 + $scope.childgridOptions.data[rowEntity.id].verf2 + $scope.childgridOptions.data[rowEntity.id].verf3;
                    $scope.childgridOptions.data[rowEntity.id].sumDef1 = rowNum.toFixed(2);

                    //修改列总计
                    var colNum = 0;
                    for (var i = 0; i <= 12; i++) {
                        if (colDef.name == "verf1") {
                            colNum = $scope.childgridOptions.data[i].verf1 + colNum;
                            $scope.childgridOptions.data[13].verf1 = colNum.toFixed(2);
                        }
                        if (colDef.name == "verf2") {
                            colNum = $scope.childgridOptions.data[i].verf2 + colNum;
                            $scope.childgridOptions.data[13].verf2 = colNum.toFixed(2);
                        }
                        if (colDef.name == "verf3") {
                            colNum = $scope.childgridOptions.data[i].verf3 + colNum;
                            $scope.childgridOptions.data[13].verf3 = colNum.toFixed(2);
                        }
                    }

                    //修改第13行的总计
                    var sumDef1RowNum = eval($scope.childgridOptions.data[13].verf1) + eval($scope.childgridOptions.data[13].verf2) + eval($scope.childgridOptions.data[13].verf3);
                    ...
                    //修改市场合计   除去股东都是市场合计
                    var sum_def2 = eval($scope.childgridOptions.data[13].verf1) + eval($scope.childgridOptions.data[13].verf2) + eval($scope.childgridOptions.data[13].verf3);
    ...
    $scope.initPage = function () {
        ...
        $scope.gridOptions = {
            ...
            exporterCsvFilename: '创新业务应收账款.csv',
            columnDefs: [
