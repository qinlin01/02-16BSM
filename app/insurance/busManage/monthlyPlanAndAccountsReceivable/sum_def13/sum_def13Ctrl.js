app.controller('sum_def13Ctrl', function ($rootScope, $scope, $http, $stateParams, uiGridConstants, ngDialog, ngVerify, $location, activitiModal) {
    ...
    $scope.initData = function (data) {
        ...
        var columnDefsDtata = [
            ...
            {name: 'verf25', displayName: '国网公司本部业务', type: 'number', enableCellEdit: true},
            {name: 'verf26', displayName: '网省电力公司及下属单位业务', type: 'number', enableCellEdit: true},
            {name: 'verf27', displayName: '其他市场客户业务', type: 'number', enableCellEdit: true},
        ];
        //险种
        var insuranceType = [
            {id: 0, insuranceName: "咨询业务", sumDef1: 0, verf25: 0, verf26: 0, verf27: 0},
            {id: 1, insuranceName: "合计（万元）", sumDef1: 0, verf25: 0, verf26: 0, verf27: 0}];
        $scope.childgridOptions = {
            ...
            onRegisterApi: function (gridApi) {
                ...
                $scope.childgridOptions.gridApi.edit.on.afterCellEdit($scope, function (rowEntity, colDef, newValue, oldValue) {
                    ...
                    $scope.childgridOptions.data[1].verf25 = $scope.childgridOptions.data[0].verf25.toFixed(2);
                    $scope.childgridOptions.data[1].verf26 = $scope.childgridOptions.data[0].verf26.toFixed(2);
                    $scope.childgridOptions.data[1].verf27 = $scope.childgridOptions.data[0].verf27.toFixed(2);

                    //修改第13行的总计
                    var sumDef1RowNum = eval($scope.childgridOptions.data[1].verf25) + eval($scope.childgridOptions.data[1].verf26) + eval($scope.childgridOptions.data[1].verf27);
    ...
    $scope.initPage = function () {
        ...
        $scope.gridOptions = {
            ...
            exporterCsvFilename: '风险管理咨询业务应收账款.csv',
            columnDefs: [
        ...
        $scope.gridOptions.onRegisterApi = function (gridApi) {
            ...
            $scope.gridApi.selection.on.rowSelectionChanged($scope, function (row, event) {
                ...
                if (rows.length == 1) {
                    ...
                    $scope.childgridOptions.data = $scope.ChildVO.child;
                    //分按钮权限
