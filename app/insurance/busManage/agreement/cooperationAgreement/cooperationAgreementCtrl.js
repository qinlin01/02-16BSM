 ...
 */
app.controller('cooperationAgreementCtrl', function ($rootScope, $scope, $http, $sce, $stateParams, uiGridConstants, ngDialog, ngVerify, $location, activitiModal) {
    ...
    $scope.initHttp = function () {
         ...
         * 续签VO
         * */
        $scope.onRenewVO = function () {
            layer.load(2);
            $http({
                method: "POST",
                url: $rootScope.basePath + "agreement/Renew",
                data: angular.toJson($scope.VO),
                headers: {'Content-Type': 'application/json;charset=UTF-8'},
            }).success(function (response) {
                if (response && response.code == 200) {
    ...
    $scope.initButton = function () {
        ...
        $scope.onSave = function () {
            ngVerify.check('cooperationAgreement', function (errEls) {
    ...
    $scope.initPage = function () {
        ...
        $scope.gridOptions = {
            ...
            columnDefs: [
                ...
                {name: 'customerType', displayName: '合作单位类型', width: 100, cellFilter: 'SELECT_CUSTOMERAGREEMENTTYPE'},
                {name: 'customer.name', displayName: '合作单位名称', width: 200},
                {name: 'customer.code', displayName: '合作单位信息编码', width: 150},
                {name: 'ifContainChildren', displayName: '是否包含下级单位', width: 100, cellFilter: 'SELECT_ISEQUALZERO'},
            ...
            columnDefs: [
                {
                    ...
                    width: 100,
                    enableCellEdit: true,
                    cellFilter: 'SELECT_ENCOAGREEMENTFILETYPE',
