...
app.controller('entrustmentAgreementCtrl', function ($rootScope, $scope, $sce, $http, $stateParams, uiGridConstants, ngDialog, ngVerify) {
        ...
        $scope.findOne = function (pk) {
            ...
            $http.post($scope.basePath + "agreement/findOne", {id: pk}).success(function (response) {
                ...
                if (response && response.code == "200") {
                    $scope.endDate =  response.data.agreementEnd;
    ...
    $scope.initButton = function () {
        ...
        $scope.onSave = function () {
            ngVerify.check('entrustmentAgreement', function (errEls) {
                if(!$stateParams.id){
    ...
    $scope.initPage = function () {
        ...
        $scope.gridOptions = {
            ...
            columnDefs: [
                ...
                //checkDate
                // {name: 'customer.code', displayName: '制单时间', width: 150},
