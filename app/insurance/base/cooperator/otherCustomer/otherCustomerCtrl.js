 ...
 */
app.controller('otherCustomerCtrl', function ($rootScope, $scope, $sce, $http, $stateParams, uiGridConstants, ngDialog, ngVerify) {
    ...
    $scope.initHttp = function () {
        ...
        $scope.onSaveVO = function () {
            ...
            if ($scope.childMust) {
                ...
                $scope.AccountList = $scope.VO.account;
                $scope.LinkmanList = $scope.VO.linkman;
                $scope.CustomerDeptList.data = $scope.VO.customerDept;
