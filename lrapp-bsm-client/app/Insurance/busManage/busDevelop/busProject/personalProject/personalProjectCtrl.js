 ...
 */
app.controller('personalProjectCtrl', function ($rootScope, $scope,$sce, $http, $stateParams, $location, uiGridConstants, ngDialog, ngVerify, activitiModal, workFlowDialog) {
