app.controller('sum_def14Ctrl', function ($rootScope, $scope, $http, $stateParams, uiGridConstants, ngDialog, ngVerify, $location, activitiModal) {
    ...
    $scope.initData = function (data) {
        ...
        var columnDefsDtata = [
            ...
            {name: 'verf28', displayName: '国网系统内单位国际业务', type: 'number', enableCellEdit: true},
            {name: 'verf29', displayName: '国网系统外单位国际业务', type: 'number', enableCellEdit: true}
        ];
        //险种
        var insuranceType = [
            {id: 0, insuranceName: "财产险", sumDef1: 0, verf28: 0, verf29: 0},
            {id: 1, insuranceName: "机器损坏险", sumDef1: 0, verf28: 0, verf29: 0},
            {id: 2, insuranceName: "供电责任险", sumDef1: 0, verf28: 0, verf29: 0},
            {id: 3, insuranceName: "公众责任险", sumDef1: 0, verf28: 0, verf29: 0},
            {id: 4, insuranceName: "雇主责任保险", sumDef1: 0, verf28: 0, verf29: 0},
            {id: 5, insuranceName: "机动车辆险", sumDef1: 0, verf28: 0, verf29: 0},
            {id: 6, insuranceName: "在建工程险", sumDef1: 0, verf28: 0, verf29: 0},
            {id: 7, insuranceName: "其他保险", sumDef1: 0, verf28: 0, verf29: 0},
            {id: 8, insuranceName: "咨询费", sumDef1: 0, verf28: 0, verf29: 0},
            {id: 9, insuranceName: "意外伤害保险", sumDef1: 0, verf28: 0, verf29: 0},
            {id: 10, insuranceName: "健康保险", sumDef1: 0, verf28: 0, verf29: 0},
            {id: 11, insuranceName: "人寿保险", sumDef1: 0, verf28: 0, verf29: 0},
            {id: 12, insuranceName: "咨询业务", sumDef1: 0, verf28: 0, verf29: 0},
            {id: 13, insuranceName: "合计（万元）", sumDef1: 0, verf28: 0, verf29: 0}];
        $scope.childgridOptions = {
            ...
            onRegisterApi: function (gridApi) {
                ...
                $scope.childgridOptions.gridApi.edit.on.afterCellEdit($scope, function (rowEntity, colDef, newValue, oldValue) {
                    ...
                    //修改行总计
                    var rowNum = $scope.childgridOptions.data[rowEntity.id].verf28 + $scope.childgridOptions.data[rowEntity.id].verf29;
                    ...
                    for (var i = 0; i <= 12; i++) {
                        if (colDef.name == "verf28") {
                            colNum = $scope.childgridOptions.data[i].verf28 + colNum;
                            $scope.childgridOptions.data[13].verf28 = colNum.toFixed(2);
                        }
                        if (colDef.name == "verf29") {
                            colNum = $scope.childgridOptions.data[i].verf29 + colNum;
                            $scope.childgridOptions.data[13].verf29 = colNum.toFixed(2);
                        }
                    }

                    //修改第13行的总计
                    var sumDef1RowNum = eval($scope.childgridOptions.data[13].verf28) + eval($scope.childgridOptions.data[13].verf29);
                    ...
                    //修改市场合计   除去股东都是市场合计
                    var sum_def2 = eval($scope.childgridOptions.data[13].verf28) + eval($scope.childgridOptions.data[13].verf29);
    ...
    $scope.initPage = function () {
        ...
        $scope.gridOptions = {
            ...
            exporterCsvFilename: '国际业务应收账款.csv',
            columnDefs: [
