app.controller('projectInformationCtrl', function ($rootScope, $scope, $http, $sce, $stateParams, uiGridConstants, ngDialog,$state,ngVerify, activitiModal, workFlowDialog) {
